...
EXP_KIND="NVRAM-SSD-CACHE-TCMALLOC"
MEMORY_LIMIT_GB=32
...
#COMMAND_PREFIX="TCMALLOC_SKIP_SBRK=true TCMALLOC_MEMFS_MALLOC_PATH=/mnt/ssd-swap/ TCMALLOC_MEMFS_LIMIT_MB=65536"
POSTFIX=""
...
if [[ "$EXP_KIND" == *"DRAM"* ]]; then
    ...
    WIREDTIGER_BASE_CONFIG="statistics=(all),block_cache=[enabled=true,blkcache_eviction_aggression=900,size=${NVRAM_CACHE_SIZE_GB}GB,type=dram,hashsize=32768,system_ram=${MEMORY_LIMIT_GB}GB,percent_file_in_dram=75,max_percent_overhead=10,cache_on_checkpoint=true]"
fi
