...
EXP_KIND="DRAM-YCSB-MM100"
MEMORY_LIMIT_GB=32
NVRAM_CACHE_SIZE_GB=256
CACHE_SIZE_LIMIT_GB=32
EXP_TAG=${EXP_KIND}-${NVRAM_CACHE_SIZE_GB}GB-NVRAM.${MEMORY_LIMIT_GB}GB-DRAM-${CACHE_SIZE_LIMIT_GB}GB_CACHE
